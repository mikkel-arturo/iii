<!-- generated by iii-skill-render. DO NOT EDIT (changes here are overwritten on the next render). Edit docs/0-18-0/creating-workers/triggers.mdx. -->
...
<Note>
  ...
  schemas](./functions#attach-request-and-response-schemas).
</Note>
