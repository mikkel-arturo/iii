<!-- generated by iii-skill-render. DO NOT EDIT (changes here are overwritten on the next render). Edit docs/0-18-0/using-iii/functions.mdx. -->
...
the same way (via [`iii trigger`](./cli) or
[`worker.trigger`](./triggers#call-a-function-directly)). The only thing special about them
